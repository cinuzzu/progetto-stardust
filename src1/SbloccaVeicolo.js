...
export default class SbloccaVeicolo extends Component{
    ...
    componentDidMount(){
        ...
        axios.post('https://progetto-stardust.herokuapp.com/Client/AggiungiPrenotazione_OTP' , this.state).
            then(res => {
    ...
    handler() {
        ...
        //SBLOCCO IL VEICOLO
        axios.post('https://progetto-stardust.herokuapp.com/Client/RitiroMezzo_open' , this.state)
        ...
        axios.post('https://progetto-stardust.herokuapp.com/Client/RitiroMezzo_ride' , this.state).
            then(res => {
                        ...
                        <Button style={{margin:"20px"}}
                            onClick={
                                clickEvent => {
                                    ...
                                    axios.post("https://progetto-stardust.herokuapp.com/Client//AggiungiPrenotazione_check_otp", this.state)
                                    .then( result => {
