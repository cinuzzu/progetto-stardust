                        ...
                        onClick={clickEvent => {
                            if (calculate_age(this.state.data_nascita) < 18) { alert('Per registrare un impiegato deve essere maggiorenne!') }
                                ...
                                if(this.state.opzione=="modifica"){
                                    ...
                                    axios.post("https://progetto-stardust.herokuapp.com/Admin/ModificaImpiegati_mod", this.state)
                                        .then(result => {
                                    ...
                                    axios.post("https://progetto-stardust.herokuapp.com/Admin/AggiungiImpiegati_add", this.state)
                                        .then(result => {
