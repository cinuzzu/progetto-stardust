...
export default class GestioneCorse extends React.Component{
    ...
    cercaCorse(){
        ...
        axios.post("http://progetto-stardust.herokuapp.com/Admin/TerminaCorsa_get", this.state)
            .then(result => {
                this.setState({
                    ...this.state,
                    object: result.data
    ...
    eliminaCorse(){
        ...
        axios.post("http://progetto-stardust.herokuapp.com/Admin/TerminaCorsa_del", this.state)
            .then(result => {
