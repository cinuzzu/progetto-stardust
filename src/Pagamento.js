...
export default class Pagamento extends React.Component{
    ...
    componentDidMount(){
        ...
        axios.post("https://progetto-stardust.herokuapp.com/Client/Pagamento_get_data", this.state).
                then(result => {
        ...
        if(this.state.primary_opt=="mezzo"){
            ...
            axios.post("https://progetto-stardust.herokuapp.com/Client/Pagamento_get_price", this.state)
                            ...
                            onClick= {
                                clickEvent => {
                                    ...
                                    if(this.state.modifica==true){
                                        ...
                                        axios.post("https://progetto-stardust.herokuapp.com/Client/EliminaPrenotazione_refund", this.state)
                                        .then(result => {
                                        ...
                                        axios.post("https://progetto-stardust.herokuapp.com/Client/ModificaPrenotazione", this.state).
                                        then(result => {
                                        ...
                                        axios.post("https://progetto-stardust.herokuapp.com/Client/EliminaPrenotazione_refund_up", this.state).
                                            then(result => {
                                        ...
                                        axios.post("https://progetto-stardust.herokuapp.com/Client/AggiungiPrenotazione_add", this.state).
                                        then(result => {
                                            ...
                                            axios.post("https://progetto-stardust.herokuapp.com/Client/Pagamento_pay", this.state).
                                            then(result => {
                                ...
                                onClick= {
                                    clickEvent => {
                                        ...
                                        if(this.state.modifica==true){
                                            ...
                                            axios.post("https://progetto-stardust.herokuapp.com/Client/AggiungiPrenotazione_add_div", this.state).
                                            then(result => {
