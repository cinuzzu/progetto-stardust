...
export default class Disponibili extends Component{
    ...
    componentDidMount(){
        if(this.state.opzione==="mezzo"){
            ...
            axios.post("http://progetto-stardust.herokuapp.com/Client/AggiungiPrenotazione_vehicles", this.state).
            then(result => {
                ...
                axios.post("http://progetto-stardust.herokuapp.com/Client/AggiungiPrenotazione_drivers", this.state).
                then(result => {
