...
export default class NotificheAutista extends Component{
    ...
    componentWillMount(){
        ...
        axios.post("http://progetto-stardust.herokuapp.com/Employer/NotificaPrenotazioni_pren", this.state).
            then(result => {
                    this.setState({
                    ...this.state,
                    object: result.data,
                        ...
                        <Button variant="primary" style={{margin:"20px"}}
                            onClick={
                                clickEvent=>{
                                    ...
                                    axios.post("http://progetto-stardust.herokuapp.com/Employer/NotificaPrenotazioni_ride", oggettoAggiungiNotifica).
                                    then(result => {
                                        alert("Prenotazione accettata con successo!")

                                        axios.post("http://progetto-stardust.herokuapp.com/Employer/NotificaPrenotazioni_em", oggettoEmail).
                                        then(result => {
                        ...
                        <Button variant="danger"
                            onClick={
                                clickEvent=>{
                                    ...
                                    axios.post("http://progetto-stardust.herokuapp.com/Employer/NotificaPrenotazioni_driver", oggettoRifiutaPrenotazione).
                                        then(result => {
                                        ...
                                        if(result.status===404){
                                            ...
                                            axios.post("http://progetto-stardust.herokuapp.com/Employer/NotificaPrenotazioni_ref", this.state).
                                                then(result => {
                                                
                                                    axios.post("http://progetto-stardust.herokuapp.com/Employer/NotificaPrenotazioni_nem", oggettoEmailNegativa).
                                                        then(result => {
                                                        alert("È stata inviata una mail di conferma al cliente")
                                                        document.location.href = '/NotificheAutista';
