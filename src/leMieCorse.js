...
export default class LeMieCorse extends Component{
    ...
    componentWillMount(){
        ...
        axios.post("http://progetto-stardust.herokuapp.com/Client/TerminaCorsa_get", this.state).
            then(result => {
                            ...
                            <Button variant="dark" style={{margin:"10px"}}
                                onClick={
                                    clickEvent =>{              
                                        ...
                                        axios.post("http://progetto-stardust.herokuapp.com/Client/TerminaCorsa_del", oggetto).
                                        then(result => {
