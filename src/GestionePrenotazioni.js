...
export default class GestionePrenotazioni extends React.Component{
    ...
    cercaPrenotazioni(){
        ...
        axios.post("http://progetto-stardust.herokuapp.com/Admin/EliminaPrenotazione_get", this.state)
            .then(result => {
                this.setState({
                    ...this.state,
                    object: result.data
    ...
    eliminaPrenotazione(){
        ...
        axios.post("http://progetto-stardust.herokuapp.com/Admin/EliminaPrenotazione_del", this.state)
            .then(result => {
