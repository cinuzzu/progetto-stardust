...
export default class SegnalaRitardo extends Component{
    ...
    componentDidMount(){
        ...
        axios.post("http://progetto-stardust.herokuapp.com/Client/Segnalazione_pren", this.state).
            then(result => {
                this.setState({
                    ...this.state,
                    object: result.data
            ...
            <div align="center">
                ...
                <Button 
                    onClick={clickEvent => {
                        ...
                        axios.post("http://progetto-stardust.herokuapp.com/Client/Segnalazione", this.state).
                            then(result => {
